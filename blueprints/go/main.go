...
This example is based on the JavaScript sample from the API Gateway documentation:
https://docs.aws.amazon.com/apigateway/latest/developerguide/use-custom-authorizer.html#api-gateway-custom-authorizer-token-lambda-function-create
*/
